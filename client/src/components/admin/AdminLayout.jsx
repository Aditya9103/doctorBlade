    ...
    <>
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-extrabold text-sm leading-tight">DoctorBlade</p>
      ...
      <nav className="flex-1 px-4 py-5 space-y-1">
        <p className="text-xs font-bold text-white uppercase tracking-widest px-3 mb-3">Menu</p>
        {navItems.map((item) => {
      ...
      <div className="px-4 py-5 border-t border-white/10">
        <div className="flex items-center gap-3 px-3 mb-3">
          ...
          <div>
            <p className="text-white text-sm font-semibold leading-tight">{admin?.username}</p>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col">
        ...
        <header className="bg-white border-b border-slate-200 sticky top-0 z-40">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <Link to="/" target="_blank" className="text-xs font-semibold text-blue-600 hover:underline flex items-center gap-1">
              View Site
