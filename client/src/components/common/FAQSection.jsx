    ...
    <section className="py-16 lg:py-24 bg-white border-t border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <h4 className="text-blue-600 font-bold tracking-widest text-xs uppercase mb-3">{subtitle || "Frequently Asked Questions"}</h4>
            ...
            return (
              <div 
                ...
                className={`border rounded-2xl transition-all duration-300 h-max ${
                  isOpen ? 'border-blue-200 shadow-md' : 'border-gray-200 bg-white hover:border-blue-300 hover:shadow-sm'
                }`}
              >
                <button
                ...
                >
                  ...
                  <span className={`flex-shrink-0 w-6 h-6 flex items-center justify-center transition-colors ${isOpen ? 'text-blue-600' : 'text-blue-500'}`}>
                    {isOpen ? (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="px-6 pb-6 pt-2 text-gray-600 leading-relaxed text-sm ml-8">
                    {faq.answer}
                  </div>
                </div>
              </div>
