    ...
    <section className="py-16 lg:py-24 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-10">
          <div>
            <h4 className="text-blue-600 font-bold tracking-wider text-sm uppercase mb-2">Latest Insights</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {articles.map((article) => (
            <div key={article.id} className="flex bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all group cursor-pointer h-28">
