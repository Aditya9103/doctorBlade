      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12 lg:py-0">
        <div className="flex flex-col lg:flex-row shadow-2xl lg:shadow-none rounded-3xl overflow-hidden lg:rounded-none">
          ...
          <div className="w-full lg:w-4/12 bg-slate-900 text-white p-8 lg:py-24 lg:pr-12">
            <h4 className="text-blue-400 font-bold tracking-wider text-xs uppercase mb-2">Quality & Certifications</h4>
            <h2 className="text-3xl font-extrabold leading-tight mb-6">
              Committed to Global Standards
            </h2>
            <p className="text-slate-400 mb-8 leading-relaxed text-sm">
              Our products are manufactured and inspected to meet strict quality standards, ensuring consistent performance and reliability in every application.
            </p>
          ...
          <div className="w-full lg:w-4/12 bg-slate-800 lg:bg-transparent flex items-center justify-center p-8 lg:p-0 relative z-20">
            <div className="bg-white p-2 rounded-xl shadow-2xl w-full max-w-sm transform lg:scale-110 border border-gray-200 hover:zoom-200  transition-transform ">
              <div className="border-4 border-double border-gray-200 p-2 flex flex-col items-center justify-center text-center bg-gray-50 relative overflow-hidden">
                <img src="/certification.jpg" alt="ISO 9001:2015 Certificate" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-4/12 bg-white p-8 lg:py-24 lg:pl-16">
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-900 text-sm">ISO 9001:2015 Certified</h4>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-900 text-sm">Reliable Performance</h4>
                  <p className="text-xs text-gray-500 mt-1">Tested for consistent results</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-900 text-sm">Premium Raw Materials</h4>
                  <p className="text-xs text-gray-500 mt-1">For long service life</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-900 text-sm">Global Customer Trust</h4>
                  <p className="text-xs text-gray-500 mt-1">Preferred by printing companies worldwide</p>
                </div>
              </div>
