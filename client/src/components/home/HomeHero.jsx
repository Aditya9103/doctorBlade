        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-gray-900 leading-tight">
              ...
              <span className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-gray-700">Manufacturer in India</span>
            </h1>

            <p className="text-lg text-gray-600 max-w-xl">
              ImageTech Industries is widely recognized for producing the best doctor blade in Delhi and across India. We manufacture premium Carbon Steel, Stainless Steel, and Polymer doctor blades that ensure flawless ink control and longer machine life for printing and packaging applications.
            </p>
            ...
            <div className="flex flex-row gap-2 sm:gap-4 overflow-x-auto hide-scrollbar pb-1">
              ...
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-gray-200">
              <div className="flex flex-col space-y-2">
                ...
                <div>
                  <h4 className="font-semibold text-sm text-gray-900">Premium Quality</h4>
                  <p className="text-xs text-gray-500">Strict quality control</p>
                </div>
              </div>
              <div className="flex flex-col space-y-2">
                <div className="bg-blue-50 w-12 h-12 rounded-xl flex items-center justify-center text-blue-600">
                ...
                <div>
                  <h4 className="font-semibold text-sm text-gray-900">Custom Sizes</h4>
                  <p className="text-xs text-gray-500">As per your requirement</p>
                </div>
              </div>
              <div className="flex flex-col space-y-2">
                <div className="bg-blue-50 w-12 h-12 rounded-xl flex items-center justify-center text-blue-600">
                ...
                <div>
                  <h4 className="font-semibold text-sm text-gray-900">Reliable Delivery</h4>
                  <p className="text-xs text-gray-500">PAN India & Global</p>
                </div>
              </div>
              <div className="flex flex-col space-y-2">
                <div className="bg-blue-50 w-12 h-12 rounded-xl flex items-center justify-center text-blue-600">
                ...
                <div>
                  <h4 className="font-semibold text-sm text-gray-900">Technical Support</h4>
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col space-y-3 z-20 hidden md:flex">
              ...
              <div className="group flex items-center bg-blue-900/80 backdrop-blur-sm p-2 rounded-l-full border border-blue-700/50 text-white shadow-xl cursor-pointer">
                <div className="w-8 h-8 rounded-full border border-blue-400 flex items-center justify-center shrink-0">
                  <svg className="w-4 h-4 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                </div>
              ...
              <div className="group flex items-center bg-blue-900/80 backdrop-blur-sm p-2 rounded-l-full border border-blue-700/50 text-white shadow-xl cursor-pointer">
                <div className="w-8 h-8 rounded-full border border-blue-400 flex items-center justify-center shrink-0">
                  <svg className="w-4 h-4 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </div>
                <span className="max-w-0 overflow-hidden opacity-0 group-hover:max-w-[200px] group-hover:opacity-100 group-hover:ml-2 transition-all duration-500 ease-in-out whitespace-nowrap text-xs font-semibold tracking-wide flex items-center">
