      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-1/2 pr-0 lg:pr-12 xl:pr-20 z-20">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed font-medium max-w-lg">
            We're here to help. Reach out to our team for product inquiries, technical support, quotations, or any other information.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
            <div className="flex items-center">
              ...
              <span className="font-bold text-sm text-gray-900 leading-snug">Quick<br />Response</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="font-bold text-sm text-gray-900 leading-snug">Expert<br />Support</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="font-bold text-sm text-gray-900 leading-snug">Reliable<br />Partnership</span>
            </div>
          </div>
        ...
        <div className="hidden lg:block absolute top-0 right-0 w-1/2 h-full z-0 overflow-hidden">
          ...
          <img src="/heroimage.png" alt="ImageTech Products" className="w-full h-full object-cover object-left opacity-90 mix-blend-multiply" />
