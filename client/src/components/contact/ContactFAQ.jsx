...
const contactFaqData = [
  ...
  },
  {
    ...
    answer:
    "Yes, we provide comprehensive technical support. Whether you need help selecting the right blade profile, troubleshooting a printing defect, or optimizing blade pressure, our experts are just a phone call or email away.",
  },
  {
    question: "Can I request product samples before placing a bulk order?",
    answer:
    "Absolutely. We understand the importance of testing products in your specific printing environment. Contact our sales team to discuss receiving sample blades tailored to your press specifications.",
  },
  {
