    ...
    <section className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          {/* Details Side */}
          <div className="w-full lg:w-1/2">
            <h4 className="text-blue-600 font-bold tracking-wider text-sm uppercase mb-2">Quality Assurance</h4>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-8">
              Certified ISO 9001:2015
            </h2>
            <p className="text-lg text-gray-600 mb-10 leading-relaxed">
              Our quality management system has been rigorously audited and certified to meet international standards. We maintain strict protocols at every stage of production to guarantee the finest products for our global clientele.
            </p>
            ...
            <div className="space-y-6 bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-5">
                  <h3 className="text-lg font-bold text-gray-900">Certificate Number</h3>
                  <p className="text-gray-500 font-medium">IN57402A</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-5">
                  ...
                  <p className="text-gray-500 font-medium">27 July 2024</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-5">
                  <h3 className="text-lg font-bold text-gray-900">Valid Until</h3>
                  <p className="text-gray-500 font-medium">26 July 2027</p>
                </div>
              </div>
            </div>

            <div className="mt-10">
              <a href="/certification.jpg" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition-colors group">
