...
const certificationsFaqData = [
  ...
  },
  {
    ...
    answer:
    "Our quality control process includes continuous dimensional checks, edge profile inspection using high-magnification optical comparators, and surface finish analysis to ensure flawless Doctor Blades.",
  },
  {
    question: "Are your products compliant with food packaging regulations?",
    answer:
    "Many of our stainless steel and specific polymer doctor blades are suitable for indirect food contact applications. If you have specific FDA or EU compliance requirements for food packaging printing, please discuss this with our technical team.",
  },
  {
    question:
