    ...
    <div className="bg-slate-50 min-h-screen py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 font-medium">Last Updated: 9/7/2026</p>
        </div>

        {/* Content */}
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 prose prose-blue max-w-none text-gray-700">
          
          <h3 className="text-xl font-bold text-gray-900 mb-3 mt-0">1. Introduction</h3>
          ...
          <ul className="list-disc pl-5 mb-8 space-y-2">
            <li><strong>Name and Contact Data:</strong> email address, phone number, postal address</li>
            <li><strong>Business Information:</strong> company name, industry, job title</li>
            <li><strong>Inquiry details:</strong> and product requirements</li>
          </ul>
          ...
          <p className="mb-4 leading-relaxed">
            If you have questions or comments about this policy, you may email us at <a href="mailto:imagetechindustries@gmail.com" className="text-blue-600 hover:underline">imagetechindustries@gmail.com</a> or contact us by post at:
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 font-medium">
            ...
            <p className="mt-2 text-gray-900"><span className="text-gray-500">Phone:</span> +91 8448336036</p>
          </div>
        ...
        {/* Back Link */}
        <div className="mt-8">
          <Link to="/" className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition-colors">
